...
//Значит те сущности, в которых все элементы идут строго по порядку:
// [], '', Map, Set, DOM-collection 

//для таких объектов будет работать перебор for ... of причем лишние свойства которые унаследуют такие объекты - не попадают в перебор (например лишние методы)


//Чтобы сделать объект итерируемым
const salaries = {
    john: 500,
    ivan: 1000,
    anna: 5000,
...
//нужно добавить в объект символ итерейтор
